...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./assets/index-keCIU7mk.js").then(function(n) {
      return n.i;
    }).then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./assets/error-404-D0EIjITR.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./assets/error-500-sUuNL09-.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import("./assets/island-renderer--oE2KIX0.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
