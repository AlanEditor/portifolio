...
const layouts = {
  default: () => import("./default-rd7ij7PG.js").then((m) => m.default || m)
};
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ id: "about" }, _attrs))} data-v-748cdaa5><div class="relative z-10 bg-gray-900 pb-20 sm:pb-24 xl:pb-0" data-v-748cdaa5><div class="absolute inset-0 overflow-hidden" aria-hidden="true" data-v-748cdaa5><div class="absolute left-[calc(50%-19rem)] top-[calc(50%-36rem)] transform-gpu blur-3xl" data-v-748cdaa5><div class="aspect-[1097/1023] w-[68.5625rem] bg-gradient-to-r from-[#ff4694] to-[#776fff] opacity-25" style="${ssrRenderStyle({ "clip-path": "polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)" })}" data-v-748cdaa5></div></div></div><div class="mx-auto flex max-w-7xl flex-col items-center gap-x-8 gap-y-10 px-6 sm:gap-y-8 lg:px-8 xl:flex-row xl:items-stretch" data-v-748cdaa5><div class="-mt-8 w-full max-w-2xl xl:-mb-8 xl:w-96 xl:flex-none" data-v-748cdaa5><div class="relative aspect-square h-full md:-mx-8 xl:mx-0 xl:aspect-auto" data-v-748cdaa5><img class="absolute inset-0 h-full w-full rounded-2xl bg-image hover:scale-105 transition duration-300 object-cover shadow-2xl"${ssrRenderAttr("src", _imports_0)} alt data-v-748cdaa5></div></div><div class="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24" data-v-748cdaa5><figure class="relative isolate pt-6 sm:pt-2" data-v-748cdaa5><blockquote class="leading-8 text-white sm:leading-9" data-v-748cdaa5><h1 class="text-6xl font-bold" data-v-748cdaa5>${ssrInterpolate($options.getTranslation("Olá", $data.actualLanguage))},</h1><p class="mt-6 text-lg" data-v-748cdaa5>${ssrInterpolate($options.getTranslation("Sobre-mim", $data.actualLanguage))}</p></blockquote></figure><div class="mt-10" data-v-748cdaa5><a href="https://www.linkedin.com/in/alan-santos-profile/" target="_blank" class="mr-4 px-6 py-3 bg-transparent text-white rounded-lg" data-v-748cdaa5>`);
  ...
  _push(`LinkedIn </a><a href="https://github.com/AlanEditor" target="_blank" class="mr-4 px-6 py-3 bg-transparent text-white rounded-lg" data-v-748cdaa5>`);
  _push(ssrRenderComponent(_component_Icon, {
    name: "uil:github",
    color: "white",
    size: "20px",
  ...
  _push(`GitHub </a></div><div class="my-10 flex justify-center md:justify-start mx-2" data-v-748cdaa5><button type="button" class="px-6 py-3 bg-transparent border border-white hover:border-blue-500 hover:text-blue-500 text-white rounded-lg" style="${ssrRenderStyle({ "z-index": "1000" })}" data-v-748cdaa5>Download CV</button></div></div></div></div></div>`);
}
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-748cdaa5"]]);
const __default__$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(contacts, (contact) => {
        _push(`<div class="flex gap-x-3">`);
        _push(ssrRenderComponent(_component_Icon, {
          name: contact.icon,
          class: "h-10 w-10 mb-2"
        }, null, _parent));
        _push(`<p class="mt-1">${ssrInterpolate(contact.value)}</p></div>`);
      });
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-1cc738bc>`);
  _push(ssrRenderComponent(_component_NuxtLayout, { name: "default" }, null, _parent));
  _push(`<main data-v-1cc738bc>`);
  _push(ssrRenderComponent(_component_initialSection, null, null, _parent));
  _push(`<div class="${ssrRenderClass([{ "animate__animated animate__fadeIn": $data.aboutVisible }, "section"])}" data-v-1cc738bc>`);
  _push(ssrRenderComponent(_component_aboutSection, null, null, _parent));
  _push(`</div><div class="${ssrRenderClass([{ "animate__animated animate__fadeIn": $data.expirienceVisible }, "section"])}" data-v-1cc738bc>`);
  _push(ssrRenderComponent(_component_expirienceSection, null, null, _parent));
  _push(`</div><div class="${ssrRenderClass([{ "animate__animated animate__fadeIn": $data.stackVisible }, "section"])}" data-v-1cc738bc>`);
  _push(ssrRenderComponent(_component_stackSection, null, null, _parent));
  _push(`</div><div class="${ssrRenderClass([{ "animate__animated animate__fadeIn": $data.testimonialVisible }, "section"])}" data-v-1cc738bc>`);
  _push(ssrRenderComponent(_component_testimonialSection, null, null, _parent));
  _push(`</div><div class="${ssrRenderClass([{ "animate__animated animate__fadeIn": $data.contactVisible }, "section"])}" data-v-1cc738bc>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-1cc738bc"]]);
...
//# sourceMappingURL=index-jXSPXitW.js.map
