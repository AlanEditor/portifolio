import { defineComponent, h, inject, computed, unref, ref, provide, Suspense, nextTick, mergeProps, Transition, useSSRContext, resolveComponent } from "vue";
...
const layouts = {
  default: () => import("./default-ThXfaVvi.js").then((m) => m.default || m)
};
...
const _imports_0$3 = "" + __buildAssetsURL("fundo-imagem.xxYpY26G.png");
const _sfc_main$8 = {
  name: "initialSection",
  data() {
    return {
...
const _imports_0$2 = "" + __buildAssetsURL("alan.ehUaHxzs.png");
const _sfc_main$7 = {
  name: "aboutSection",
  data() {
    return {
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$4], ["__scopeId", "data-v-4528c4e9"]]);
const _imports_0$1 = "" + __buildAssetsURL("ensinio.7fqJmFjL.png");
const _imports_1$1 = "" + __buildAssetsURL("iporto.ZKpnBZJ8.png");
const _imports_2$1 = "" + __buildAssetsURL("casa_de_ge.W7bZfft_.png");
const _imports_3$1 = "" + __buildAssetsURL("cm.cz2JZ1_G.png");
const _sfc_main$6 = {};
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "mt-32" }, _attrs))}><div class="mt-6 grid grid-cols-1 lg:grid-cols-4 gap-x-8 gap-y-10"><div class="overflow-hidden rounded-lg bg-gray-900 hover:scale-105 transition duration-300"><a href="https://www.ensinio.com" target="_blank"><img${ssrRenderAttr("src", _imports_0$1)} class="object-cover object-center"></a></div><div class="overflow-hidden rounded-lg bg-gray-900 hover:scale-105 transition duration-300"><a href="https://www.iporto.com.br" target="_blank"><img${ssrRenderAttr("src", _imports_1$1)} class="object-cover object-center"></a></div><div class="overflow-hidden rounded-lg bg-gray-900 hover:scale-105 transition duration-300"><a href="https://casadege.com.br" target="_blank"><img${ssrRenderAttr("src", _imports_2$1)} class="object-cover object-center"></a></div><div class="overflow-hidden rounded-lg bg-gray-900 hover:scale-105 transition duration-300"><img${ssrRenderAttr("src", _imports_3$1)} class="object-cover object-center"></div><div class="mt-4 flex items-center justify-between space-x-8 text-base font-medium text-gray-900"></div></div></div>`);
}
...
const _imports_0 = "" + __buildAssetsURL("laravel.2w5j14HS.png");
const _imports_1 = "" + __buildAssetsURL("php.6SAekbGD.png");
const _imports_2 = "" + __buildAssetsURL("vue.PxwK4KdQ.png");
const _imports_3 = "" + __buildAssetsURL("docker.7nh1Ehpu.png");
const _imports_4 = "" + __buildAssetsURL("mysql.ZuOIHGwn.png");
const _imports_5 = "" + __buildAssetsURL("node.XTxab9r5.png");
const _sfc_main$4 = {};
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: "bg-image",
        id: "stack"
      }, _attrs))} data-v-b93a6d77><div data-v-b93a6d77><div class="bg-gradient-to-t from-black bottom-0 py-24 sm:py-32" data-v-b93a6d77><div class="mx-auto max-w-7xl px-6 lg:px-8" data-v-b93a6d77><div class="grid grid-cols-1 items-center gap-x-8 gap-y-16 lg:grid-cols-2" data-v-b93a6d77><div class="mx-auto w-full max-w-xl lg:mx-0" data-v-b93a6d77><h2 class="mt-2 text-5xl font-bold tracking-tight text-white sm:text-4xl lg:text-6xl text-center lg:text-left" data-v-b93a6d77>${ssrInterpolate(unref(getTranslation)("Minha Stack", _ctx.actualLanguage))}</h2><p class="mt-6 text-lg leading-8 text-gray-300 text-center lg:text-left" data-v-b93a6d77>${ssrInterpolate(unref(getTranslation)("descricao da stack", _ctx.actualLanguage))}</p></div>`);
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-b93a6d77"]]);
const __default__$1 = {
  name: "expirienceSection",
  data() {
    return {
...
//# sourceMappingURL=index-e6pZJn38.js.map
