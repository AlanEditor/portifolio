...
import { defineComponent, h, inject, computed, unref, ref, Suspense, nextTick, mergeProps, Transition, provide, useSSRContext } from 'file:///Users/alansantos/Desktop/PROJETOS/PORTIFO%CC%81LIO/portifolio/node_modules/vue/dist/vue.cjs.prod.js';
...
import { ssrRenderAttrs, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrRenderClass, ssrRenderStyle, ssrRenderComponent } from 'file:///Users/alansantos/Desktop/PROJETOS/PORTIFO%CC%81LIO/portifolio/node_modules/vue/server-renderer/index.mjs';
...
const layouts = {
  default: () => import('./default-GbBEi8yH.mjs').then((m) => m.default || m)
};
...
const _imports_0$1 = "" + buildAssetsURL("fundo-imagem.xxYpY26G.png");
const _sfc_main$6 = {
  name: "initialSection",
  data() {
    return {
...
const _imports_0 = "" + buildAssetsURL("alan.ehUaHxzs.png");
const _sfc_main$5 = {
  name: "aboutSection",
  data() {
    return {
...
const _sfc_main$4 = /* @__PURE__ */ Object.assign(__default__$3, {
  ...
  setup(__props) {
    const jobs = [
      ...
      {
        company: "Casa de G\xEA",
        imageSrc: `casa_de_ge.png`,
        link: "https://casadege.com.br/"
      },
      {
        company: "Congrega\xE7\xE3o Mariana",
        imageSrc: `cm.png`
      }
    ];
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(jobs, (job, index2) => {
        _push(`<div class="group relative opacity-75 hover:opacity-100 hover:scale-105 transition duration-300 hover:border-white rounded-lg p-6"><div class="overflow-hidden rounded-lg bg-gray-900"><img${ssrRenderAttr("src", `..src/assets/img/${job.imageSrc}`)} class="object-cover object-center"></div><div class="mt-4 flex items-center justify-between space-x-8 text-base font-medium text-gray-900"></div><h3 class="text-white text-center"><a${ssrRenderAttr("href", job.link)} target="_blank"><span aria-hidden="true" class="absolute inset-0"></span></a></h3></div>`);
      });
      _push(`<!--]--></div></div></div>`);
    };
  }
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: "bg-image",
        id: "stack"
      }, _attrs))} data-v-b352544c><div data-v-b352544c><div class="bg-gradient-to-t from-black bottom-0 py-24 sm:py-32" data-v-b352544c><div class="mx-auto max-w-7xl px-6 lg:px-8" data-v-b352544c><div class="grid grid-cols-1 items-center gap-x-8 gap-y-16 lg:grid-cols-2" data-v-b352544c><div class="mx-auto w-full max-w-xl lg:mx-0" data-v-b352544c><h2 class="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-6xl text-center lg:text-left" data-v-b352544c>${ssrInterpolate(unref(getTranslation)("Minha Stack", _ctx.actualLanguage))}</h2><p class="mt-6 text-lg leading-8 text-gray-300 text-center lg:text-left" data-v-b352544c>${ssrInterpolate(unref(getTranslation)("descricao da stack", _ctx.actualLanguage))}</p></div><div class="mx-auto grid w-full max-w-lg grid-cols-3 items-center gap-y-5 sm:gap-y-5 lg:mx-0 lg:max-w-none lg:pl-8" data-v-b352544c><!--[-->`);
      ssrRenderList(technologies, (stack, index2) => {
        _push(`<div class="group relative opacity-75 hover:opacity-100 hover:border-white rounded-lg p-6" data-v-b352544c><div class="overflow-hidden rounded-lg bg-gray-900" data-v-b352544c><img${ssrRenderAttr("src", `..src/assets/img/${stack}.png`)} class="object-cover object-center hover:scale-105 transition duration-300" data-v-b352544c></div><div class="mt-4 flex items-center justify-between space-x-8 text-base font-medium text-gray-900" data-v-b352544c></div></div>`);
      });
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-b352544c"]]);
const __default__$1 = {
  name: "expirienceSection",
  data() {
    return {
...
//# sourceMappingURL=index-OjGHx2zT.mjs.map
