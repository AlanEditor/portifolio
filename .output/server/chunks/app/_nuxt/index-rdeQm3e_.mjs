...
import { defineComponent, h, inject, computed, unref, ref, Suspense, nextTick, mergeProps, Transition, provide, useSSRContext } from 'vue';
...
const layouts = {
  default: () => import('./default-Wnuve3Y_.mjs').then((m) => m.default || m)
};
...
//# sourceMappingURL=index-rdeQm3e_.mjs.map
