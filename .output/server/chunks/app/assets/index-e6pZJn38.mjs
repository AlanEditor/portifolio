...
import { defineComponent, h, inject, computed, unref, ref, Suspense, nextTick, mergeProps, Transition, provide, useSSRContext, resolveComponent } from 'vue';
...
const layouts = {
  default: () => import('./default-ThXfaVvi.mjs').then((m) => m.default || m)
};
...
//# sourceMappingURL=index-e6pZJn38.mjs.map
